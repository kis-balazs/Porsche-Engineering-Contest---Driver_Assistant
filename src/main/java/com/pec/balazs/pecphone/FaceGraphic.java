...
class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawText("Left eye open: " + face.getIsLeftEyeOpenProbability(), 50, 50, mIdPaint);
        canvas.drawText("Right eye open: " + face.getIsRightEyeOpenProbability(), 50, 100, mIdPaint);
        canvas.drawText("Smiling in: " + face.getIsSmilingProbability(), 50, 150, mIdPaint);
    }
}